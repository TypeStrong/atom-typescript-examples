...
items[ObjectType.CookedMeat].onUse[UseType.Eat] = [
    2,
    5,
    8,
    -2
...
items[ObjectType.EarthWorm].onUse[UseType.Eat] = [
    0,
    2,
    1,
    0
...
items[ObjectType.SeaWaterWaterskin].onUse[UseType.Drink] = [
    0,
    -15,
    1,
    -2
...
items[ObjectType.CommonMushrooms].onUse[UseType.Eat] = [
    3,
    2,
    2,
    -1
...
items[ObjectType.Nopal].onUse[UseType.Eat] = [
    0,
    3,
    3,
    1
...
items[ObjectType.Bandage].onUse[UseType.Heal] = [
    12,
    0,
    0,
    0
...
items[ObjectType.Suture].onUse[UseType.Heal] = [
    8,
    0,
    0,
    0
...
items[ObjectType.RawMeat].onUse[UseType.Eat] = [
    -2,
    2,
    7,
    -2
...
items[ObjectType.RedBerries].onUse[UseType.Eat] = [
    1,
    1,
    2,
    0
...
items[ObjectType.RedMushroom].onUse[UseType.Eat] = [
    -5,
    8,
    2,
    -1
...
items[ObjectType.Seaweed].onUse[UseType.Eat] = [
    0,
    1,
    1,
    -1
...
items[ObjectType.ThistleSeeds].onUse[UseType.Eat] = [
    3,
    0,
    1,
    0
...
items[ObjectType.TreeFungus].onUse[UseType.Eat] = [
    0,
    7,
    3,
    -1
...
items[ObjectType.PeatBandage].onUse[UseType.Heal] = [
    15,
    0,
    0,
    0
...
items[ObjectType.RawCod].onUse[UseType.Eat] = [
    1,
    1,
    5,
    -1
...
items[ObjectType.CookedCod].onUse[UseType.Eat] = [
    2,
    4,
    6,
    -1
...
items[ObjectType.PileOfSnow].onUse[UseType.Eat] = [
    1,
    10,
    1,
    3
...
items[ObjectType.RawFishSteak].onUse[UseType.Eat] = [
    1,
    1,
    6,
    -1
...
items[ObjectType.CookedFishSteak].onUse[UseType.Eat] = [
    2,
    4,
    6,
    -1
...
items[ObjectType.DesalinatedWaterWaterskin] = {
    ...
    group: [
        ObjectType.Water,
        ObjectType.PotableWaterskin
    ],
    returnOnUse: ObjectType.Waterskin
};
items[ObjectType.DesalinatedWaterWaterskin].onUse[UseType.Drink] = [
    2,
    15,
    1,
    10
...
items[ObjectType.Flask] = {
    ...
    recipe: {
        requires: [
            [
                ObjectType.ClayBlowPipe,
                1,
                0
            ],
            [
                ObjectType.RefinedSand,
                2,
                2
            ],
            [
                ObjectType.LimestonePowder,
                1,
                1
            ]
        ],
...
items[ObjectType.IronTongs] = {
    ...
    recipe: {
        requires: [
            ...
            [
                ObjectType.HammerLike,
                1,
                0
            ],
            [
                ObjectType.SandCastFlask,
                1,
                0
            ]
        ],
...
items[ObjectType.PlantRoots].onUse[UseType.Eat] = [
    1,
    2,
    1,
    0
...
items[ObjectType.Pineapple].onUse[UseType.Eat] = [
    5,
    5,
    5,
    3
...
items[ObjectType.RottenMeat].onUse[UseType.Eat] = [
    -10,
    -20,
    1,
    -1
...
items[ObjectType.RawChicken].onUse[UseType.Eat] = [
    -10,
    -10,
    6,
    -1
...
items[ObjectType.CookedChicken].onUse[UseType.Eat] = [
    5,
    5,
    8,
    -2
...
items[ObjectType.AnimalFat].onUse[UseType.Eat] = [
    0,
    -6,
    2,
    -1
...
items[ObjectType.SlimeGelatin].onUse[UseType.Eat] = [
    -1,
    -2,
    2,
    -1
...
items[ObjectType.CookedSpider].onUse[UseType.Eat] = [
    3,
    5,
    2,
    0
...
items[ObjectType.DeadSpider].onUse[UseType.Eat] = [
    -1,
    -2,
    2,
    -1
...
items[ObjectType.RottingVegetation].onUse[UseType.Eat] = [
    -10,
    -15,
    1,
    -1
...
items[ObjectType.WildOnion].onUse[UseType.Eat] = [
    4,
    4,
    3,
    0
...
items[ObjectType.Coconut].onUse[UseType.Eat] = [
    5,
    5,
    5,
    4
...
items[ObjectType.Offal].onUse[UseType.Eat] = [
    -2,
    -6,
    3,
    -1
...
items[ObjectType.Tourniquet].onUse[UseType.Heal] = [
    2,
    0,
    0,
    0
...
items[ObjectType.MedicinalWaterWaterskin].onUse[UseType.Cure] = [
    3,
    8,
    1,
    9
...
items[ObjectType.CharcoalBandage].onUse[UseType.Cure] = [
    14,
    0,
    0,
    0
...
items[ObjectType.PurifiedFreshWaterWaterskin] = {
    ...
    recipe: {
        requires: [
            [
                ObjectType.UnpurifiedFreshWaterWaterskin,
                1,
                1
            ]
        ],
...
items[ObjectType.PurifiedFreshWaterWaterskin].onUse[UseType.Drink] = [
    2,
    15,
    1,
    10
...
items[ObjectType.UnpurifiedFreshWaterWaterskin].onUse[UseType.Drink] = [
    -4,
    8,
    1,
    8
...
items[ObjectType.SeaWaterGlassBottle].onUse[UseType.Drink] = [
    0,
    -15,
    1,
    -2
...
items[ObjectType.DesalinatedWaterGlassBottle] = {
    ...
    recipe: {
        requires: [
            ...
            [
                ObjectType.SeaWaterGlassBottle,
                1,
                1
            ]
        ],
    ...
    group: [
        ObjectType.Water,
        ObjectType.PotableBottle
    ],
    returnOnUse: ObjectType.GlassBottle
};
items[ObjectType.DesalinatedWaterGlassBottle].onUse[UseType.Drink] = [
    2,
    15,
    1,
    10
...
items[ObjectType.MedicinalWaterGlassBottle].onUse[UseType.Cure] = [
    3,
    8,
    1,
    9
...
items[ObjectType.PurifiedFreshWaterGlassBottle] = {
    ...
    recipe: {
        requires: [
            [
                ObjectType.UnpurifiedFreshWaterGlassBottle,
                1,
                1
            ]
        ],
...
items[ObjectType.PurifiedFreshWaterGlassBottle].onUse[UseType.Drink] = [
    2,
    15,
    1,
    10
...
items[ObjectType.UnpurifiedFreshWaterGlassBottle].onUse[UseType.Drink] = [
    -4,
    8,
    1,
    8
...
items[ObjectType.WroughtIronArrow] = {
    ...
    recipe: {
        requires: [
            ...
            [
                ObjectType.WroughtIronArrowhead,
                1,
                1,
                1
            ],
...
items[ObjectType.RawTaintedMeat].onUse[UseType.Eat] = [
    -8,
    1,
    7,
    -3
...
items[ObjectType.CookedTaintedMeat].onUse[UseType.Eat] = [
    -4,
    2,
    8,
    -2
...
items[ObjectType.RawBlindfish].onUse[UseType.Eat] = [
    0,
    2,
    4,
    -1
...
items[ObjectType.CookedBlindfish].onUse[UseType.Eat] = [
    1,
    5,
    5,
    -1
...
items[ObjectType.PreparedPemmican].onUse[UseType.Eat] = [
    1,
    6,
    6,
    -2
...
items[ObjectType.Egg].onUse[UseType.Eat] = [
    -1,
    6,
    3,
    1
...
items[ObjectType.BoiledEgg].onUse[UseType.Eat] = [
    2,
    6,
    3,
    0
...
items[ObjectType.Giblets].onUse[UseType.Eat] = [
    0,
    -1,
    4,
    -1
...
items[ObjectType.SeaWaterClayJug].onUse[UseType.Drink] = [
    0,
    -15,
    1,
    -2
...
items[ObjectType.DesalinatedWaterClayJug].onUse[UseType.Drink] = [
    2,
    15,
    1,
    10
...
items[ObjectType.MedicinalWaterClayJug].onUse[UseType.Cure] = [
    3,
    8,
    1,
    9
...
items[ObjectType.PurifiedFreshWaterClayJug] = {
    ...
    recipe: {
        requires: [
            [
                ObjectType.UnpurifiedFreshWaterClayJug,
                1,
                1
            ]
        ],
...
items[ObjectType.PurifiedFreshWaterClayJug].onUse[UseType.Drink] = [
    2,
    15,
    1,
    10
...
items[ObjectType.UnpurifiedFreshWaterClayJug].onUse[UseType.Drink] = [
    -4,
    8,
    1,
    8
